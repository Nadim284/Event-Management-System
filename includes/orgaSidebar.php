...
$map = [
  ...
  'permissionLetter'            => 'permissionLetter',         // public/pages/permissionLetter.php
  ...
  <div>
    ...
    <nav>
      ...
      <ul class="ems-menu">
        ...
        <li class="ems-item">
          <a href="<?= $BASE ?>/public/pages/invitation.php" class="<?= active('invitation', $currentPage) ?>">
            <span class="ems-icon">🗓️</span><span>Invitation</span>
          </a>
        </li>
        <li class="ems-item">
          <a href="<?= $BASE ?>/public/pages/permissionLetter.php" class="<?= active('permissionLetter', $currentPage) ?>">
            <span class="ems-icon">📬</span><span>Previous program</span>
          </a>
        </li>
        <li class="ems-item">
          <a href="<?= $BASE ?>/public/pages/permissionLetter.php" class="<?= active('permissionLetter', $currentPage) ?>">
            <span class="ems-icon">📬</span><span>Permission Letter</span>
          </a>
        </li>
        <li class="ems-item">
